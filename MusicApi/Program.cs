using MusicApi.ProgramSetup.ServiceSetup;
using MusicApi.ProgramSetup.ApplicationSetup;

var builder = WebApplication.CreateBuilder(args);

// Aggiunge tutte le configurazioni di servizio
ProjectServiceRegistration.AddProjectServices(builder.Services, builder.Configuration);

var app = builder.Build();

// Configura l'applicazione usando le configurazioni di middleware definite
ApplicationBuilderSetup.ConfigureMiddleware(app, app.Environment);
